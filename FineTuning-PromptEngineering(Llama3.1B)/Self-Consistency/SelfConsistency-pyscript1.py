...
dfr = pd.read_csv('Questions2.csv', encoding='utf-8')
print(dfr)
for index, row in dfr.iterrows():
    print(index)
    body = row['question']
    temperature = 0.7
    prompt = "Please answer this question: " + str(body) + " Show all work. Output your answer like this: \#\#\#work: <work> \#\#\# Answer: <answer>."
...
print('done1')
dfr.to_csv('out_selfconsistency2.csv')
...
df = pd.read_csv('out_selfconsistency2.csv',  encoding='utf-8')
print(df)
...
df.to_csv('out_selfconsistency2.csv')
